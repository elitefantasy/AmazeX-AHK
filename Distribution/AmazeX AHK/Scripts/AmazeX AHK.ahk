...
; Autolaunch
;----------------------------------------------------------------------------------------------------
; Run, %A_ScriptDir%\Tools\AmazeX-sorter.ahk ; deprecated
...
;_________________________________________________
	...
	; Menu, Tray, add, Utility,Function ;deprecated
	; Menu, Tray, Icon, Utility, %A_ScriptDir%\..\Resources\Icons\AmazeX.ico ; deprecated
	; Menu, Utility, Add, Open, OpenGui ; deprecated
	...
	Menu, Tray,Icon, Restart, %A_ScriptDir%\..\Resources\Icons\reload.ico,

	Menu, Tray, Add, Exit,
	Menu, Tray,Icon,Exit,%A_ScriptDir%\..\Resources\Icons\cross.ico


	; Menu,Tray,Add,Utility,:Utility ;deprecated
