...
Menu, Tray, Add, Show/Hide, Menu_ShowHide ;commented by akm
Menu, Tray, Add,
Menu, Tray, Add, Exit, Close
Menu, Tray, Default, Show/Hide ;commented by akm
...
Menu_ShowHide: ;commented by akm
    ToggleShowHide() ;commented by akm
return
